        ...
        for protein1_state_chain, protein2_state_chain in zip(protein1_match_chains, protein2_match_chains):
            if protein1_state_chain and protein2_state_chain:
                for chains in product(protein1_state_chain, protein2_state_chain):
                    ...
                    """
                        pdb_site1=alignment_result[pdb_name][(state, protein1_chain)][3][alignment_result[pdb_name][(state, protein1_chain)][1][
                                site1 - 1]]
                        pdb_site2=alignment_result[pdb_name][(state, protein2_chain)][3][alignment_result[pdb_name][(state, protein2_chain)][1][
                                site2 - 1]]
                    except:
                        print(pdb_name,protein1_state_chain,protein2_state_chain)
                    """
