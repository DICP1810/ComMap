...
class CFunctionParseUniprot:
    ...
    def buildUniprotPDBMap(self,uniprot_ids,data_package=CDataPack()):
        uniprot_files_path = [data_package.my_config.C60_TYPE01_DATA_PATH+r'/' + i + '.xml' for i in uniprot_ids]
...
class CFunctionParseCIF:
    ...
    def parseCIFSequenceFromAtom(self, pdb_name,folder):
        try:
            ...
            print(f'\n[ComMap] Failed parsing structure {pdb_name}, the file might be corrupted.')
            return [], []
